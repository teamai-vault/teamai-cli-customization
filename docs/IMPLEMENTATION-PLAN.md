...
- arbitrary or generic resource copying or injection (the only narrow exception is the frozen Marketplace-managed `instructions/**/*.instructions.md` contract described above);
